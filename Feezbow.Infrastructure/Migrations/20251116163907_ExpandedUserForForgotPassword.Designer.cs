...
namespace WannabeTrello.Infrastructure.Migrations
{
    ...
    [Migration("20251116163907_ExpandedUserForForgotPassword")]
    partial class ExpandedUserForForgotPassword
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WannabeTrello.Domain.Entities.ActivityTracker", b =>
                {
                    ...
                    b.Property<Dictionary<string, object>>("NewValue")
                        .HasColumnType("jsonb");

                    b.Property<Dictionary<string, object>>("OldValue")
                        .HasColumnType("jsonb");
