...
public interface ITaskNotificationService
{
    ...
    Task NotifyTaskAssigned(long taskId, long? oldAssigneeId, long? newAssigneeId, long assignedByUserId, CancellationToken cancellationToken);
    Task NotifyTaskCommented(long taskId, long commentId, long commentAuthorId, string content, CancellationToken cancellationToken); 
